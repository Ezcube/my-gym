...
const TECHNIQUE_ACCURACY = Object.freeze({
  ...
  '0320': 'Sit on an incline bench with a dumbbell in each hand, palms facing the torso and arms fully extended. Keep the back against the bench and feet flat, keep the upper arms stationary, curl both weights to shoulder level, pause, then lower under control.',
  '0321': 'Set an incline bench to a 45-degree angle and sit with a dumbbell in each hand on the thighs. Lie back, position the dumbbells at shoulder level with palms facing each other, press them up and slightly inward to full extension, then lower slowly.',
  '1618': 'Sit on an exercise ball with a dumbbell in each hand and palms facing each other. Walk the feet forward until the head, neck, and upper back are supported on the ball, press the dumbbells up and slightly inward to full extension, then lower to shoulder level.',
  '0322': 'Sit on an incline bench with a dumbbell in each hand and palms facing each other. Rest the upper arms on the bench with elbows hanging down, rotate the palms forward, keep the upper arms stationary, curl both weights to shoulder level, then lower slowly.',
  '1619': 'Sit on an incline bench with a dumbbell in one hand resting on the thigh. Lean back and raise it to shoulder height, rotate the wrist so the palm faces inward, press the dumbbell up and away to full extension, then lower and switch arms.',
  '1620': 'Sit on an exercise ball with a dumbbell in one hand. Walk your feet forward until your head, neck, and upper back are supported on the ball, hold the dumbbell with the palm facing inward and elbow bent at 90 degrees, press it toward the ceiling to straighten the arm, lower, then switch arms.',
  '0323': 'Sit on an incline bench with a dumbbell in one hand resting on the thigh. Lean forward and brace the upper arm against the inside of the thigh, raise the dumbbell out to the side with a slight elbow bend and palm down until the arm is parallel to the floor, lower, then switch arms.',
  '0324': 'Set an incline bench at a 45-degree angle and sit with a dumbbell in each hand and palms facing each other. Keep the back straight against the bench, start at shoulder level, press the dumbbells up and away to full extension, pause, then lower slowly.',
  '0325': 'Sit on an incline bench with a dumbbell in each hand resting on the thighs. Lean back, raise the dumbbells to shoulder height with palms forward, then press them overhead to full extension and lower back to shoulder height under control.',
  '0326': 'Set an incline bench at a 45-degree angle and sit with the chest against the backrest, holding a dumbbell in each hand with palms facing each other. Let the arms hang straight down, raise them out to the sides with a slight elbow bend until parallel to the ground, pause, then lower under control.',
  '0327': 'Set up an incline bench at a 45-degree angle. Place the chest against the incline backrest, keep the feet stable, and hold a dumbbell in each hand with the arms fully extended toward the floor. Pull both dumbbells toward the chest while squeezing the shoulder blades, pause, then lower slowly.',
  '0328': 'Set an incline bench to a 45-degree angle and sit with the back supported, feet flat, and a dumbbell in each hand with palms facing down. Start with the dumbbells on the thighs, raise them to shoulder height, rotate the wrists so the palms face forward, press overhead with a slight elbow bend, then lower under control.',
  '0329': 'Set an incline bench to a 45-degree angle and sit with the back supported, feet flat, and a dumbbell in each hand with palms facing the body. Let the arms hang straight down, elevate both shoulders toward the ears while keeping the elbows and arms straight, pause, then lower slowly.',
  '0330': 'Sit on an incline bench with a dumbbell in each hand and palms facing inward. Extend both arms overhead with the elbows close to the head, bend only the elbows to lower the dumbbells behind the head while keeping the upper arms stationary, then extend back overhead.',
  '0331': 'Set an incline bench to a 45-degree angle and sit with a dumbbell in each hand and palms facing each other. Lie back and press the dumbbells above the chest, lower them outward in a wide arc with a slight elbow bend while rotating the wrists so the palms face forward at the bottom, then reverse and bring them together overhead.',
  '0332': 'Stand with feet shoulder-width apart holding a dumbbell in each hand at the sides. Raise both arms out to the sides until parallel to the ground, forming a T shape, pause, then lower slowly.',
  '0335': 'Stand with feet shoulder-width apart holding a dumbbell in each hand with palms facing the body. Keep the back straight and core engaged, raise both arms out to the sides to shoulder height, lower, then raise both arms forward to shoulder height and lower under control.',
  '0337': 'Lie flat on a bench with feet flat and hold one dumbbell with both hands, palms facing each other, arms extended above the chest. Keep the upper arms stationary and lower the dumbbell in an arc behind the head until the forearms are near parallel to the floor, then extend the triceps to return overhead.',
  '0338': 'Lie flat on a bench with feet flat and a dumbbell in each hand, palms facing each other, arms extended over the chest. Lower both dumbbells toward the shoulders by bending only the elbows while keeping the upper arms stationary, then press them back up by extending the elbows.',
  '0339': 'Lie flat on your back with a single dumbbell resting securely across the lower abdomen or pelvis. Bend both knees and draw the lower legs toward the glutes while keeping the weight stable, pause, then slowly extend the knees back to the starting position.',
  '0340': 'Lie flat on a bench with feet flat, holding a dumbbell in each hand with palms facing each other and arms extended straight up. Lower both dumbbells to the sides of the chest with elbows near 90 degrees, then press them back up to full extension.',
  '0341': 'Lie face down on a flat bench with a dumbbell in one hand and the palm facing inward. Let the working arm hang straight down close to the body, raise it up and back while squeezing the shoulder blade toward the spine, lower, then switch arms.',
  '0342': 'Lie flat on a bench with the back supported and feet flat. Hold one dumbbell in one hand with the palm facing the feet, extend the arm above the chest with a slight elbow bend, lower toward the chest with the elbow close to the body, then press back up and switch arms.',
  '0343': 'Lie flat on a bench with feet flat and hold one dumbbell in one hand at shoulder level with the palm facing forward. Press the dumbbell upward until the arm is fully extended, pause, lower slowly, then switch arms.',
  '0344': 'Lie flat on a bench with the back and head supported and feet flat. Hold one dumbbell with the palm facing down and extend the arm above the shoulder. Keep the upper arm stationary, lower the dumbbell behind the head by bending the elbow, then extend back up and switch arms.',
  '0345': 'Lie face down on a flat bench with a dumbbell in one hand hanging toward the floor. Keep the arm straight and lift the dumbbell out to the side away from the body, lower, then switch arms.',
  '0346': 'Lie flat on a bench with the back and head supported and feet flat. Hold one dumbbell in one hand with an underhand grip, extend it above the shoulder, keep the upper arm stationary, lower behind the head by bending the elbow, extend, then switch arms.',
  '0347': 'Lie face down on a flat bench with a dumbbell in each hand and arms extended straight down. Rotate the palms upward, then keeping the upper arms stationary curl the dumbbells while rotating the palms to face down, and lower slowly.',
  '0349': 'Lie flat on a bench with feet flat. Hold a dumbbell in each hand with palms facing up and arms fully extended. Keep the upper arms stationary, curl both dumbbells toward the shoulders using the forearms, pause, then lower under control.',
  '0350': 'Lie flat on a bench with a dumbbell in each hand, palms facing up and arms fully extended. Keep the upper arms stationary, curl both weights to shoulder level, pause, then lower slowly.',
...
const MUSCLE_GROUP_OVERRIDES = Object.freeze({
  ...
  '0320': { primary: ['Biceps'], secondary: ['Forearms'] },
  '0321': { primary: ['Chest'], secondary: ['Shoulders', 'Triceps'] },
  '1618': { primary: ['Triceps'], secondary: ['Chest', 'Shoulders'] },
  '0322': { primary: ['Biceps'], secondary: ['Forearms'] },
  '1619': { primary: ['Triceps'], secondary: ['Shoulders', 'Chest'] },
  '1620': { primary: ['Triceps'], secondary: ['Shoulders', 'Chest'] },
  '0323': { primary: ['Shoulders'], secondary: ['Traps', 'Triceps'] },
  '0324': { primary: ['Chest'], secondary: ['Shoulders', 'Triceps'] },
  '0325': { primary: ['Shoulders'], secondary: ['Traps', 'Triceps'] },
  '0326': { primary: ['Shoulders'], secondary: ['Traps', 'Rhomboids'] },
  '0327': { primary: ['Upper back'], secondary: ['Biceps', 'Shoulders'] },
  '0328': { primary: ['Serratus'], secondary: ['Shoulders', 'Traps'] },
  '0329': { primary: ['Traps'], secondary: ['Shoulders'] },
  '0330': { primary: ['Triceps'], secondary: ['Shoulders'] },
  '0331': { primary: ['Chest'], secondary: ['Shoulders', 'Triceps'] },
  '0332': { primary: ['Shoulders'], secondary: ['Triceps', 'Chest'] },
  '0335': { primary: ['Shoulders'], secondary: ['Traps', 'Biceps'] },
  '0337': { primary: ['Triceps'], secondary: ['Shoulders'] },
  '0338': { primary: ['Triceps'], secondary: ['Chest', 'Shoulders'] },
  '0339': { primary: ['Hamstrings'], secondary: ['Glutes'] },
  '0340': { primary: ['Chest'], secondary: ['Triceps', 'Shoulders'] },
  '0341': { primary: ['Shoulders'], secondary: ['Traps', 'Upper back'] },
  '0342': { primary: ['Chest'], secondary: ['Triceps', 'Shoulders'] },
  '0343': { primary: ['Chest'], secondary: ['Triceps', 'Shoulders'] },
  '0344': { primary: ['Triceps'], secondary: ['Shoulders'] },
  '0345': { primary: ['Shoulders'], secondary: ['Traps', 'Upper back'] },
  '0346': { primary: ['Triceps'], secondary: ['Forearms'] },
  '0347': { primary: ['Forearms'], secondary: ['Biceps', 'Shoulders'] },
  '0349': { primary: ['Forearms'], secondary: ['Biceps', 'Shoulders'] },
  '0350': { primary: ['Biceps'], secondary: ['Forearms'] },
