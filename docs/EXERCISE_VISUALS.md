...
This fork ships original generated technique and target-muscle images for the 636 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 636 manifest IDs and 1272 WebP files;
