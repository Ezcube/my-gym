...
This fork ships original generated technique and target-muscle images for the 641 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 641 manifest IDs and 1282 WebP files;
