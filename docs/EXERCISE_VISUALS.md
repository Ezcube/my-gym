...
This fork ships original generated technique and target-muscle images for the 666 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 666 manifest IDs and 1332 WebP files;
