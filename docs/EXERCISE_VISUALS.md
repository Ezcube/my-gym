...
This fork ships original generated technique and target-muscle images for the 671 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 671 manifest IDs and 1342 WebP files;
