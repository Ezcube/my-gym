...
This fork ships original generated technique and target-muscle images for the 351 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 351 manifest IDs and 702 WebP files;
