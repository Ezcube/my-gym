...
This fork ships original generated technique and target-muscle images for the 165 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 165 manifest IDs and 330 WebP files;
