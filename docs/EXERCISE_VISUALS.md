...
This fork ships original generated technique and target-muscle images for the 307 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 307 manifest IDs and 614 WebP files;
