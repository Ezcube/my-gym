...
This fork ships original generated technique and target-muscle images for the 661 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 661 manifest IDs and 1322 WebP files;
