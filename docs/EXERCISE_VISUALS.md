...
This fork ships original generated technique and target-muscle images for the 441 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 441 manifest IDs and 882 WebP files;
