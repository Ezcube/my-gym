...
This fork ships original generated technique and target-muscle images for the 606 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 606 manifest IDs and 1212 WebP files;
