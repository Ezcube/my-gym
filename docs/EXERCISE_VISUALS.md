...
This fork ships original generated technique and target-muscle images for the 140 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 140 manifest IDs and 280 WebP files;
