...
This fork ships original generated technique and target-muscle images for the 287 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 287 manifest IDs and 574 WebP files;
