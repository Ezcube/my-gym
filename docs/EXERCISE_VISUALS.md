...
This fork ships original generated technique and target-muscle images for the 466 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 506 manifest IDs and 1012 WebP files;
