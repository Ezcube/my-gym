...
This fork ships original generated technique and target-muscle images for the 267 exercise IDs listed in `frontend/src/lib/exercise-visuals.js`. The remaining catalogue uses the built-in MuscleMap-derived body diagram.
...
- exactly 267 manifest IDs and 534 WebP files;
