...
export default {
  ...
  "This browser doesn't support passkeys — you can still use openGym locally on this device.": 'Этот браузер не поддерживает ключи доступа — но «Мой зал» можно использовать локально на этом устройстве.',
  ...
  'to install openGym as a full-screen app.': 'чтобы установить «Мой зал» как полноэкранное приложение.',
  ...
  'Rest-timer alerts, even if openGym is closed.': 'Оповещения таймера отдыха, даже если приложение «Мой зал» закрыто.',
  ...
  'A small file a friend imports into their own openGym — routines only, none of your workouts or weigh-ins.': 'Небольшой файл, который друг импортирует в приложение «Мой зал» — только программы, без твоих тренировок и взвешиваний.',
  ...
  'Reload openGym': 'Перезагрузить Мой зал',
